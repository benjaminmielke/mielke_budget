...
# ─────────────────────────────────────────────────────────────────────────────
# 2) Updated CSS for Mobile–Optimized Compact Layout
# ─────────────────────────────────────────────────────────────────────────────
st.markdown("""
<style>
/* Updated container for each line item for a compact mobile layout */
.line-item-container {
    display: flex;
    flex-direction: row;
    flex-wrap: nowrap;       /* Keep all components on one row */
    align-items: center;
...
/* Prevent spans and buttons from wrapping and truncate if needed */
.line-item-container span, .line-item-container button {
    white-space: nowrap;
    overflow: hidden;
